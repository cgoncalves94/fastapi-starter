...
from pydantic import EmailStr, Field, field_validator, SecretStr, model_validator

from src.api.v1.schemas.common import BaseSchema, TimestampMixin
from src.api.v1.schemas.shared import WorkspaceMembershipInfo
...
class UserWithWorkspaces(UserResponse):
    ...
    workspaces: list[WorkspaceMembershipInfo] = []
